...
export default function TextInputField(props) {
	...
	const styles = StyleSheet.create({
		Container: {
			...
			flexDirection: 'row',
			height: props.textInputRow ? (props.textInputRow.height ? props.textInputRow.height : 60) : 50,
		...
		textInput: {
			...
			color: '#393E46',
			paddingLeft: props.textInput ? (props.textInput.paddingLeft ? props.textInput.paddingLeft : 10) : 0,
